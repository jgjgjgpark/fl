  ...
  async create(organization) {
    const transactionItems = [{
      Put: {
        ...
        TableName: _OrganizationRepo.TABLE_NAME,
...
var OrganizationRepo = _OrganizationRepo;
OrganizationRepo.TABLE_NAME = "federated-learning-table";

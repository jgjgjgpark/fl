...
class DefaultApi(object):
    ...
    def analyses_analysis_id_executions_post(self, analysis_id, **kwargs):  # noqa: E501
        """analyses_analysis_id_executions_post  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.analyses_analysis_id_executions_post(analysis_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.analyses_analysis_id_executions_post_with_http_info(analysis_id, **kwargs)  # noqa: E501
        else:
            (data) = self.analyses_analysis_id_executions_post_with_http_info(analysis_id, **kwargs)  # noqa: E501
            return data

    def analyses_analysis_id_executions_post_with_http_info(self, analysis_id, **kwargs):  # noqa: E501
        """analyses_analysis_id_executions_post  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.analyses_analysis_id_executions_post_with_http_info(analysis_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method analyses_analysis_id_executions_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('analysis_id' not in params or
            ...
            raise ValueError("Missing the required parameter `analysis_id` when calling `analyses_analysis_id_executions_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/analyses/{analysisId}/executions', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
